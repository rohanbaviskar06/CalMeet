  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 max-w-5xl">
      <div className="mb-6 md:mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight mb-2">Embed: {eventType.title}</h1>
        <p className="text-muted-foreground text-sm md:text-base">Choose how you want to add this event type to your website.</p>
      </div>
