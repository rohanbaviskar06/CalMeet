  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Button className="gap-2" render={<a href="/dashboard/event-types/new" />} nativeButton={false}>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card key={event.id} className={cn("group transition-all", !event.isActive && "opacity-60")}>
            ...
            <CardFooter className="pt-4 border-t flex items-center justify-between">
              <CopyLinkButton 
                ...
                slug={event.slug} 
              />
              <Button variant="outline" size="sm" render={<a href={`/dashboard/event-types/${event.id}`} />} nativeButton={false}>
                Edit Details
              </Button>
            </CardFooter>
          </Card>
        ...
        <a href="/dashboard/event-types/new" className="h-full min-h-[240px] rounded-2xl border-2 border-dashed border-muted-foreground/20 hover:border-primary/50 hover:bg-muted/30 transition-all flex flex-col items-center justify-center gap-4 group text-left">
