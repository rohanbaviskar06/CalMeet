        ...
        >
          <div className="space-y-1.5 text-center">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400">
              Start scheduling meetings seamlessly in less than 2 minutes.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-9 rounded-lg font-semibold text-xs mt-3"
            >
              {isLoading ? (
                <>
                  <Loader2 className="h-3.5 w-3.5 animate-spin mr-1.5" /> Creating account...
                </>
              ) : (
