    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-32 pb-24">
        <section className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 italic font-serif">CalMeet for Recruiting</h1>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 p-10 rounded-[3rem] bg-secondary/20 border">
               <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-8 text-lg">
                    Connect CalMeet with your Applicant Tracking System to keep candidate data synced and interview notes centralized.
                  </p>
      ...
      <footer className="py-12 border-t bg-muted/50">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} CalMeet Inc. Recruitment Solutions.
        </div>
      </footer>
    </div>
  );
