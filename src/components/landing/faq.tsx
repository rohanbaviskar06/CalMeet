...
const faqs = [
  {
    question: "Is MeetMe really free to start?",
    answer:
      "Yes — MeetMe's free plan includes unlimited one-on-one event types, your personal booking link, and Google/Outlook calendar sync. No credit card required. Upgrade to Pro when you need advanced features like team scheduling, payments, or custom branding.",
  },
  {
    question: "How does the calendar sync work?",
    answer:
      "MeetMe connects to your Google or Outlook calendar via OAuth (no passwords stored). It reads your busy times in real-time to prevent double bookings, and writes new meetings back to your calendar automatically when someone books.",
  },
  {
    question: "Can I accept payments before a meeting?",
    answer:
      "Yes. Connect Stripe to your account and add a price to any event type. MeetMe will collect payment during the booking flow — the meeting is only confirmed once payment succeeds. Great for consultants, coaches, and service providers.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "On the Pro plan, yes. You can set a custom URL (yourbrand.meetme.app), upload a logo, choose brand colors, and add a profile photo. Your booking page will look like a natural extension of your brand.",
  },
  {
    question: "Does MeetMe work for teams?",
    answer:
      "Absolutely. MeetMe for Teams supports round-robin scheduling, collective availability, and shared team pages. You can route incoming bookings to the right team member automatically based on load or availability.",
  },
  {
    question: "How do I embed MeetMe on my website?",
    answer:
